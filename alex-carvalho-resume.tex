...
\begin{adjustwidth}{4pt}{4pt} \large {\fontfamily{ptm}\selectfont EDUCATION} \end{adjustwidth}
...
\begin{adjustwidth}{4pt}{4pt} \large {\fontfamily{ptm}\selectfont PROFESSIONAL EXPERIENCE} \end{adjustwidth}
\rule[8pt]{\linewidth}{0.4pt}
...
\begin{adjustwidth}{4pt}{4pt} \large {\fontfamily{ptm}\selectfont OTHER EXPERIENCE} \end{adjustwidth}
\rule[8pt]{\linewidth}{0.4pt}
...
\begin{adjustwidth}{4pt}{4pt} \large {\fontfamily{ptm}\selectfont SKILLS} \end{adjustwidth}
\rule[8pt]{\linewidth}{0.4pt}
...
\begin{adjustwidth}{4pt}{4pt} \large {\fontfamily{ptm}\selectfont PROJECTS \& OPEN-SOURCE} \end{adjustwidth}
\rule[8pt]{\linewidth}{0.4pt}
